    ...
    public function toArray(Request $request): array
    {
        ...
        if ($this->student)
        {
            return [
                ...
                'rates'   => $request->subject_id != null ? StudentRateResource::collection($this->student->rates()->whereSubjectId($request->subject_id)->get()) : StudentRateResource::collection($this->student->rates()->whereSubjectId($default_subject->subject_id)->get()),
                'rewards' => $request->subject_id != null ? StudentRewardResource::collection($this->student->rewards()->whereSubjectId($request->subject_id)->get()) : StudentRewardResource::collection($this->student->rewards()->whereSubjectId($default_subject->subject_id)->get()),
            ...
            return [
                ...
                'rates'   => $request->subject_id != null ? StudentRateResource::collection($this->rates()->whereSubjectId($request->subject_id)->get()) : StudentRateResource::collection($this->rates()->whereSubjectId($default_subject->subject_id)->get()),
                'rewards' => $request->subject_id != null ? StudentRewardResource::collection($this->rewards()->whereSubjectId($request->subject_id)->get()) : StudentRewardResource::collection($this->rewards()->whereSubjectId($default_subject->subject_id)->get()),
