                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('settings.bank_transfers')}}"></a>
                            @lang('messages.bank_transfers')
                        </li>
                    </ol>
                </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($transfers as $transfer)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        {{app()->getLocale() == 'ar' ? $transfer->course->name_ar : $transfer->course->name_en}}
                                    </td>
                                    <td>
                                        {{$transfer->price}} @lang('messages.SR')
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success-{{$transfer->id}}">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-success">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>
                                                            <img src="{{asset('/uploads/transfers/' . $transfer->transfer_photo)}}" width="400" height="400">
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-outline-light" data-dismiss="modal">@lang('messages.close')</button>
                                                    </div>
                                                </div>
                                                <!-- /.modal-content -->
                                            </div>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info" href="{{route('settings.bank_transfer_submit' , [$transfer->id , 'done'])}}">
                                            <i class="fa fa-user-edit"></i> @lang('messages.confirm')
                                        </a>

                                        <a class="btn btn-danger" href="{{route('settings.bank_transfer_submit' , [$transfer->id , 'remove'])}}">
