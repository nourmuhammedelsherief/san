            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-success">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('teachers.adminUpdate' , $teacher->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label"> @lang('messages.school') </label>
                                    <input name="school" type="text" class="form-control" value="{{$teacher->school}}"
                                           placeholder="@lang('messages.school')">
                                    @if ($errors->has('school'))
                                        <span class="help-block">
                                            <strong style="color: red;">{{ $errors->first('school') }}</strong>
                                        </span>
                                    @endif
                                </div>
                                <div class="form-group">
