                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.admins') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="{{ url('/admin/admins') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="username" name="name" type="text" value="{{ old('name') }}" class="form-control" placeholder="@lang('messages.name')">
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="email" name="email" type="email" value="{{ old('email') }}" class="form-control" placeholder="@lang('messages.email')">
                                        @if ($errors->has('email'))
                                            <span class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="phone" name="phone" type="text" value="{{ old('phone') }}" class="form-control" placeholder="@lang('messages.phone_number')">
                                        @if ($errors->has('phone'))
                                            <span class="help-block">
