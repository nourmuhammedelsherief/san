...
@section('title')
    @lang('messages.teacher_notifications') @lang('messages.specified')
@endsection
@section('style')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.teacher_notifications') @lang('messages.specified')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('teacher_notifications')}}">
                                @lang('messages.teacher_notifications') @lang('messages.specified')
                            </a>
                        </li>
                    </ol>
                ...
                <!-- general form elements -->
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.teacher_notifications') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('store_teacher_notifications')}}" method="post"
                              enctype="multipart/form-data">
                            <input type='hidden' name='_token' value='{{Session::token()}}'>

                            <div class="card-body">
                                <div class="form-group">
                                    <label class="control-label"> @lang('messages.teachers') </label>
                                    <select class="select2-multiple form-control" name="teachers[]" multiple="multiple"
                                    ...
                                    @if ($errors->has('teachers'))
                                        <span class="help-block">
                                            <strong style="color: red;">{{ $errors->first('teachers') }}</strong>
                                        </span>
                                    @endif
                                </div>
                                <div class="form-group">
