...
@section('title')
    @lang('messages.add') @lang('messages.subjects')
@endsection
@section('style')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.subjects') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.subjects') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('subjects.store')}}" method="post" enctype="multipart/form-data">
