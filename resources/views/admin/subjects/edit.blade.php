...
@section('title')
    @lang('messages.edit') @lang('messages.subjects')
@endsection
@section('style')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.subjects') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.subjects') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('subjects.update' , $subject->id)}}" method="post" enctype="multipart/form-data">
                            <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>

                            <div class="card-body">
                                <div class="form-group">
                                    <label class="control-label"> @lang('messages.name_ar') </label>
                                    <input name="name_ar" type="text" class="form-control" value="{{$subject->name_ar}}" placeholder="@lang('messages.name_ar')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name_en" type="text" class="form-control" value="{{$subject->name_en}}" placeholder="@lang('messages.name_en')">
