                            ...
                            @foreach($subjects as $subject)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info" href="{{route('subjects.edit' , $subject->id)}}">
                                            <i class="fa fa-user-edit"></i> @lang('messages.edit')
                                        </a>

                                        <a class="delete_data btn btn-danger" data="{{ $subject->id }}" data_name="{{app()->getLocale() == 'ar' ? $subject->name_ar : $subject->name_en}}" >
        ...
        $( document ).ready(function () {
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/subjects/delete/" + id;
