...
@section('title')
    @lang('messages.edit') @lang('messages.subscribers')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.subscribers') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.subscribers') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('users.update' , $user->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control" value="{{$user->name}}" placeholder="@lang('messages.name')">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="email" type="email" class="form-control" value="{{$user->email}}" placeholder="@lang('messages.email')">
                                    @if ($errors->has('name'))
                                        <span class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="phone" type="number" class="form-control" value="{{$user->phone}}" placeholder="@lang('messages.phone_number')">
                                    @if ($errors->has('phone'))
                                        <span class="help-block">
