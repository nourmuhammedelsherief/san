...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('messages.subscribers')</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th>@lang('messages.active_courses')</th>
                            ...
                            @foreach($users as $user)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="{{route('user_courses' , $user->id)}}" class="btn btn-success"> {{\App\Models\UserCourse::whereStatus('active')->whereUserId($user->id)->count()}} </a>
                                    </td>
                                    <td>
