                        ...
                        <form role="form" action="{{route('seller_codes.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="code" type="text" class="form-control" value="{{old('code')}}" placeholder="@lang('messages.code')">
                                    @if ($errors->has('code'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        <option value="school"> @lang('messages.a_school') </option>
                                        <option value="teacher"> @lang('messages.a_teacher') </option>
                                    </select>
                                    @if ($errors->has('type'))
                                        <span class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="discount" type="number" class="form-control" value="{{old('discount')}}" placeholder="@lang('messages.discount_percentage')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="start_at" type="date" class="form-control" value="{{old('start_at')}}" placeholder="@lang('messages.start')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="status" type="radio"  value="active"> @lang('messages.active')
                                    <input name="status" type="radio"  value="not_active"> @lang('messages.not_active')
