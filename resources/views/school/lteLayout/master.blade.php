...
{{--    <link rel="icon" type="image/x-icon" href="{{asset('/uploads/'. \App\Models\Setting::first()->logo)}}">--}}
    <!-- Tell the browser to be responsive to screen width -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link type="text/css" rel="icon" href="{{ URL::asset('/uploads/'. \App\Models\Setting::first()->logo) }}" type="image/x-icon">
...
@include('school.lteLayout.header')

@include('school.lteLayout.sidebar')
...
{{--        <strong>--}}
{{--            @lang('messages.all_rights_reserved').@lang('messages.copyRight')--}}
