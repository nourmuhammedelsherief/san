...
@section('title')
    @lang('messages.edit') @lang('messages.students')
@endsection
@section('style')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.students') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.students') </h3>
                        </div>
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="classroom_id" class="form-control" required>
                                        ...
                                        @foreach($classrooms as $class)
                                            <option
                                                value="{{$class->id}}" {{$student->classroom_id == $class->id ? 'selected' : ''}}> {{$class->name}} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="gender" type="radio"
                                           value="male" {{$student->gender == 'male' ? 'checked' : ''}}> @lang('messages.male')
                                    <input name="gender" type="radio"
                                           value="female" {{$student->gender == 'female' ? 'checked' : ''}}> @lang('messages.female')
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="birth_date" type="date" class="form-control"
                                           ...
                                           placeholder="@lang('messages.birth_date')">
