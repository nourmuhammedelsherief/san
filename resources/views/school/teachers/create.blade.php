...
@section('title')
    @lang('messages.add') @lang('messages.teachers')
@endsection
@section('style')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.teachers') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.teachers') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('teachers.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="select2-multiple form-control" name="classrooms[]" multiple="multiple"
                                            id="select2Multiple">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="whatsapp" type="radio" value="true"> @lang('messages.yes')
                                    <input name="whatsapp" type="radio" value="false"> @lang('messages.no')
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="phone_number" type="text" class="form-control" value="{{old('phone_number')}}" placeholder="@lang('messages.phone_number')">
