...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('messages.rewards') ({{$teacher->name}})</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('createSchoolTeacherReward' , $teacher->id)}}" class="btn btn-info">
        ...
        $( document ).ready(function () {
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/school/teacher/rewards/delete/" + id;
