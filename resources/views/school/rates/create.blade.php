...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.rates') </h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-success">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('rates.store')}}" method="post" enctype="multipart/form-data">
                            <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>

                            <div class="card-body">
                                <div class="form-group">
                                    <label class="control-label"> @lang('messages.rate_name') </label>
                                    <input name="rate_name" type="text" class="form-control" value="{{old('rate_name')}}" placeholder="@lang('messages.rate_name')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="points" type="number" class="form-control" value="{{old('points')}}" placeholder="@lang('messages.points')">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        <option value="positive"> @lang('messages.positive') </option>
                                        <option value="negative"> @lang('messages.negative') </option>
                                    </select>
                                    @if ($errors->has('type'))
                                        <span class="help-block">
